...
class FragmentExpenseRegister(private var userId: String) : Fragment() {
    ...
    override fun onCreateView(
        ...
        registerType = view.findViewById(R.id.expenseregister_expensetype_spinner)
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        registerAdd.setOnClickListener {
            ...
            val expenseRef =
                mDatabase.getReference("expenses") // criar pasta categories no database

            val expenseId = expenseRef.push().key // criar chave aleatória

            val expense = Expense(name = name, userId = userId, expenseId = expenseId!!)
